@extends('backend.app')
@section('title',"All Accounts information")
@push('css')
        ...
        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addClient">
                            <i class="mdi mdi-plus-circle mr-1"></i>Add Account
                          </button>
            ...
            <div class="modal fade" id="addClient" tabindex="-1" role="dialog" aria-labelledby="addClient" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <h5 class="modal-title" id="addClient">Account's Information</h5>
                ...
                <form action="{{route('account.create')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Account's Name <span style="color:red"> *<span></label>
                            <input type="text" class="form-control" data-toggle="input-mask" name="account_name" id="account_name"  placeholder="Account Name" required>
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModelInfo_{{$item->id}}">
                                      ...
                                      <!-- Modal -->
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{route('account.update',$item->id)}}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label>Account's Name <span style="color:red"> *<span></label>
                                                                    <input type="text" class="form-control" data-toggle="input-mask" value=" {{ $item->account_name }}" name="account_name" id="account_name"  placeholder="Account Name" required>
                                                                    {{-- <span style="color:red;display: none" id="error_nurse_name">Name field is Required</span> --}}
                                        ...
                                        <button type="submit" onclick="Delete({{$item->id}})" class="btn btn-danger"> <i class="mdi mdi-delete"><span></span></i>  </button>
                                            ...
                                            <form action="{{route('account.destroy',$item->id)}}" method="POST" id="action-form-{{$item->id}}">
